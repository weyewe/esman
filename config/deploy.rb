...
task :deploy => :environment do
  ...
  # queue %[echo "-----> Gonna RESTART DELAYED_JOB"]
  # queue "cd #{deploy_to}/current ; RAILS_ENV=production ./bin/delayed_job stop; RAILS_ENV=production ./bin/delayed_job start; "
